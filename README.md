...
## Latest News 🔥
- [2024/6/11] We are trilled to introduce [PowerInfer-2](https://arxiv.org/abs/2406.06282), our highly optimized inference framework designed specifically for smartphones. With TurboSparse-Mixtral-47B, achieving an impressive speed of 11.68 tokens per second, which is up to 23 times faster than other state-of-the-art frameworks. 
- [2024/6/11] We are trilled to present [Turbo Sparse](https://arxiv.org/abs/2406.05955), our TurboSparse models for fast inference. Within just 0.1M dollars, we sparsified the original mistral, Mixtral to nearly 90% sparsity while keeping the better performance! For Mixtral-level model, our TruboSparse-Mixtral only activate **4B** parameters!
