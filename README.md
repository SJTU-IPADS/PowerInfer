...
- [2024/6/11] We are trilled to present [Turbo Sparse](https://arxiv.org/abs/2406.05955), our TurboSparse models for fast inference. Within just 0.1M dollars, we sparsified the original models to nearly 90% sparsity while keeping the better performance! For Mixtral-level model, our TruboSparse-Mixtral only activate **4B** parameters!
